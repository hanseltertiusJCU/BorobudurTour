 ...
 */
public class MultipleDaysTicketFragment extends Fragment {


    public MultipleDaysTicketFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items.add(new Item(getString(R.string.multiple_days_section), getString(R.string.multiple_days_section_content)));
