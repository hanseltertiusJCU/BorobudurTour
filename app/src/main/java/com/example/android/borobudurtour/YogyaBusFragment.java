 ...
 */
public class YogyaBusFragment extends Fragment{

    // Create the constructor that doesn't require input parameter
    public YogyaBusFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items.add(new Item(getString(R.string.bus_yogyakarta_section), getString(R.string.bus_yogyakarta_section_content)));
