 ...
 */
public class TicketPackagesFragment extends Fragment {


    public TicketPackagesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items.add(new Item(getString(R.string.ticket_package_section), getString(R.string.ticket_package_section_content)));
