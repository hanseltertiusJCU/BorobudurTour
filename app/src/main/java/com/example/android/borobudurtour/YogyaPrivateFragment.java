 ...
 */
public class YogyaPrivateFragment extends Fragment{

    // Create the constructor that doesn't require input parameter
    public YogyaPrivateFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items.add(new Item(getString(R.string.private_vehicle_yogyakarta_section), getString(R.string.private_vehicle_yogyakarta_section_content)));
